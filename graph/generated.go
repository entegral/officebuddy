...
func (ec *executionContext) _User_Details(ctx context.Context, field graphql.CollectedField, obj *types.User) (ret graphql.Marshaler) {
	...
	res := resTmp.(*types.UserDetails)
	fc.Result = res
	return ec.marshalNUserDetails2ᚖgithubᚗcomᚋentegralᚋofficebuddyᚋtypesᚐUserDetails(ctx, field.Selections, res)
}
...
func (ec *executionContext) _UserDetails_firstName(ctx context.Context, field graphql.CollectedField, obj *types.UserDetails) (ret graphql.Marshaler) {
...
func (ec *executionContext) _UserDetails_lastName(ctx context.Context, field graphql.CollectedField, obj *types.UserDetails) (ret graphql.Marshaler) {
...
func (ec *executionContext) _UserDetails(ctx context.Context, sel ast.SelectionSet, obj *types.UserDetails) graphql.Marshaler {
...
func (ec *executionContext) marshalNUserDetails2ᚖgithubᚗcomᚋentegralᚋofficebuddyᚋtypesᚐUserDetails(ctx context.Context, sel ast.SelectionSet, v *types.UserDetails) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
